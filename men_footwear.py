...
print("Total number of unique Rating : ", fashion_df["rating"].nunique())
...
train_data_dir = "/Users/arishbhayani/Desktop/Capstone/data/Footwear/Men/Images/"

nb_train_samples = 813
epochs = 50
batch_size = 1

def men_footwear_extract_features():
    Itemcodes = []
    ...
    extracted_features = extracted_features.reshape((813, 100352))
